...
const translations = {
  th: {
    ...
    quick_actions: 'ทางลัดการจัดการ',
    top_up_short: 'เติมเงิน',
    check_in: 'เช็คอิน',
    edit_profile_short: 'แก้โปรไฟล์',
    spending_analysis: 'วิเคราะห์การใช้จ่าย',
    no_activities_yet: 'ยังไม่มีกิจกรรมล่าสุด',
    start_activity_msg: 'เริ่มต้นใช้งานระบบเพื่อติดตามกิจกรรมของคุณที่นี่',
    profile_completion: 'ความสมบูรณ์ของโปรไฟล์',
    security_strength: 'ระดับความปลอดภัย',
    high: 'สูง',
    medium: 'ปานกลาง',
    low: 'ต่ำ',
    ...
    show_more: 'แสดงเพิ่ม',
    no_activities_found: 'ไม่พบกิจกรรมที่ค้นหา',
    try_adjust_filter: 'ลองปรับตัวกรองหรือคำค้นหาของคุณดูอีกครั้ง',
    ...
    founder: 'สมาชิกระดับผู้ก่อตั้ง (Founder)',
    legend: 'สมาชิกระดับตำนาน (Legend)',
    standard: 'สมาชิกระดับมาตรฐาน (Standard)',
  ...
  en: {
    ...
    top_up_short: 'Top-up',
    check_in: 'Check-in',
    edit_profile_short: 'Profile',
    spending_analysis: 'Spending Analysis',
    no_activities_yet: 'No activities yet',
    start_activity_msg: 'Start using the system to track your activities here.',
