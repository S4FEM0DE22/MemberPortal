...
export default function Activities() {
  ...
  const activities = [
    { id: 1, title: 'Renewal Payment: Sarah Jenkins', sub: t('annual_gold'), amount: '$249.00', time: `2 ${t('hours_ago')}`, icon: CreditCard, iconBg: 'bg-primary/10', iconColor: 'text-primary', description: 'การชำระเงินต่ออายุสมาชิกระดับ Gold รายปีดำเนินการสำเร็จผ่านระบบ Stripe', reference: 'TRX-9921-X' },
    { id: 2, title: t('approved_request'), sub: `David Miller • ${t('professional_tier')}`, status: t('certified'), time: `5 ${t('hours_ago')}`, icon: BadgeCheck, iconBg: 'bg-emerald-500/10', iconColor: 'text-emerald-500', description: 'คำขอเลื่อนระดับสมาชิกได้รับการอนุมัติโดยระบบตรวจสอบอัตโนมัติ', reference: 'REQ-4482-B' },
    { id: 3, title: t('profile_updated'), sub: `Emily Watson • Credentials Updated`, time: t('yesterday'), icon: FileEdit, iconBg: 'bg-orange-500/10', iconColor: 'text-orange-500', description: 'สมาชิกทำการอัปเดตข้อมูลที่อยู่และเบอร์โทรศัพท์ติดต่อใหม่', reference: 'LOG-1102-Z' },
    { id: 4, title: 'New Member Registered', sub: 'John Doe joined standard tier', time: t('yesterday'), icon: UserPlus, iconBg: 'bg-blue-500/10', iconColor: 'text-blue-500', description: 'สมาชิกใหม่ลงทะเบียนเข้าร่วมระบบผ่านหน้าเว็บไซต์หลัก', reference: 'MEM-3301-A' },
    { id: 5, title: 'Subscription Cancelled', sub: 'Michael Chen • Monthly Plan', time: `2 ${t('days_ago') || 'days ago'}`, icon: FileEdit, iconBg: 'bg-red-500/10', iconColor: 'text-red-500', description: 'สมาชิกขอยกเลิกการต่ออายุแพ็กเกจแบบรายเดือน', reference: 'CAN-5591-C' },
    { id: 6, title: 'Payment Failed', sub: 'Amy Liu • Gold Tier', amount: '$19.00', time: `3 ${t('days_ago') || 'days ago'}`, icon: CreditCard, iconBg: 'bg-red-500/10', iconColor: 'text-red-500', description: 'การชำระเงินไม่สำเร็จเนื่องจากบัตรเครดิตหมดอายุ', reference: 'ERR-7721-F' },
    { id: 7, title: 'System Maintenance', sub: 'Server clusters optimized', time: `4 ${t('days_ago') || 'days ago'}`, icon: BadgeCheck, iconBg: 'bg-on-surface/5', iconColor: 'text-on-surface-variant', description: 'ดำเนินการปรับปรุงประสิทธิภาพฐานข้อมูลประจำสัปดาห์', reference: 'SYS-001-K' },
    { id: 8, title: 'New Admin Added', sub: 'Sophia Brown granted dashboard access', time: `5 ${t('days_ago') || 'days ago'}`, icon: UserPlus, iconBg: 'bg-purple-500/10', iconColor: 'text-purple-500', description: 'เพิ่มสิทธิ์การเข้าถึงระดับ Admin ให้กับผู้ใช้ใหม่', reference: 'ADM-8821-S' },
  ];
